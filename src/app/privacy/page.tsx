  ...
  return (
    <PageWrapper>
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert text-foreground">
        ...
        <p>
          We collect personal information that you voluntarily provide to us when you register on the EthioHealth Connect, express an interest in obtaining information about us or our products and services, when you participate in activities on the EthioHealth Connect or otherwise when you contact us.
        </p>
        <p>
          The personal information that we collect depends on the context of your interactions with us and the EthioHealth Connect, the choices you make and the products and features you use. The personal information we collect may include the following:
        </p>
        <ul>
          <li>Names</li>
