    ...
    <PageWrapper>
      ...
      <div>
        ...
        <p className="text-muted-foreground text-center max-w-xl mx-auto">
          We are continuously working to improve EthioHealth Connect. Your feedback and participation are invaluable as we strive to build a healthier future together.
        </p>
      </div>
    </PageWrapper>
  );
